...
# имеет оклад менее 20 тысяч, вывести фамилии этих сотрудников. Выполнить
...
with open('task_5.3_input.txt', 'r', encoding='utf=8') as file:
    workers = {}
    for line in file:
        key, value = line.split()
        workers[key] = value
        if int(value) < 20000:
            print(f'{key} Оклад меньше 20000 рублей ')
