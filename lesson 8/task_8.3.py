    ...
    def input_1(self):
        while True:
            try:
                ...
                print(f'Текущий список - {self.my_exception} \n')
            except:
                print(f'Значение не допустимо - строка или текст')
                y_or_n = input(f'Будете пробовать еще раз? Y/N ')
                if y_or_n == 'Y' or y_or_n == 'y':
                    print(try_except.input_1())
