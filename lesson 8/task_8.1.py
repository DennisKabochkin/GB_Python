...
class Data:
    ...
    def valid(day, month, year):
        if 1 <= day <= 31:
            if 1 <= month <= 12:
                if 0 <= year <= 2023:
                    return f'Диапазон даты указан верно'
                else:
...
today = Data('13 - 01 - 2023')
print(today)
print(Data.valid(41, 11, 2023))
print(today.valid(21, 13, 2023))
print(Data.extract('11 - 08 - 2023'))
print(today.extract('04 - 01 - 2023'))
print(Data.valid(4, 1, 2024))
